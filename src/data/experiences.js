const experiences = [
    {
        ...
        'descriptions': [
            ...
            'I\'m part of the Cassandra team with the other 5 members. My responsibility is to collaborate with team members to deliver high-quality Cassandra features and provide the fastest bug fixes possible to Cassandra and its add-ons such as Spark, spark-jobserver, Lucene index, Debezium, Continuous data backup, etc. Apart from that, Cassandra team is responsible for delivering and offering customers with latest Cassandra major / minor versions that contain the latest bug fixes and CVEs patched while ensuring no downgrade to performance and functionalities.',
    ...
    },
    {
        ...
        'descriptions': [
            'MySunlife is a Sunlife\'s customer-centric portal. It has a web version and a hybrid app version with data processed by microservices. The target is to provide customers with up-to-date information about their policies and insurance data and allow customers to manage their policy & contracts.',
            'Together with the other 4 team members, my task was to correspond with BA to implement features that suit the business requirements and ensure on-time deliveries with tested quality and UI/UX. Satisfaction from customers is one of a primary target.',
            'This project was driven by Scrum with the following main technical stacks: Ionic Framework, Java-based microservices, Spring, MySQL, HTML, SCSS, Typescript, Angular.'
        ],
    ...
    },
    {
        ...
        'descriptions': [
            'Sunportal is a portal that serves Sunlife\'s partners (agents). It helps agents in managing customer data so they can actively reach out to customers whenever they need help.',
            'Team size for this project was 3 and my responsibilities were to design and deliver a fully responsive website version that offered great UI/UX.',
            'This project was driven by Scrum with the following main technical stacks: Java-based microservices, Spring, MySQL, HTML, SCSS, Typescript, Angular.'
        ],
    ...
    },
    {
        ...
        'descriptions': [
            'In an attempt to facilitate and support ever-growing numbers of customers, Sunlife\'s backend system embraces microservices architecture and services were all scalable to ensure the performance, manageability and the availability, especially on business-critical services.',
            'My job was to work closely with BA team to analyze and implement appropriate functionalities on various services that not only align with business requirements but also ensure feature\'s performance and avoid code smell with clean code principals. Also, to ensure bug-free, Junit tests were added as automation tests to validate all functionalities. Before deliver to customers, features were carefully tested with 2 level acceptance tests to make sure all features bring no unexpected errors.',
            'This project was driven by Scrum with the following main technical stacks: Java-based microservices, Junit Test, Spring, MySQL.'
        ],
    ...
    },
    {
        ...
        'descriptions': [
            ...
            'Waterfall methodology was applied with following main technical stacks: HTML, CSS, Typescript, Angular, Ionic',
        ],
